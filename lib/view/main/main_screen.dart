...
class _MainScreenState extends State<MainScreen> with SingleTickerProviderStateMixin {
  List<({String name, String img, Widget widget})> allData = [
    (name: "لوحة التحكم", img: "assets/icons/menu_dashboard.svg", widget: DashboardView(), ),
    (name: "الفواتير", img: "assets/icons/menu_profile.svg", widget: InvoiceType(), ),
    (name: "السندات", img: "assets/icons/menu_profile.svg", widget: BondType(), ),
    (name: "الحسابات", img: "assets/icons/menu_tran.svg", widget: AccountType(), ),
    (name: "المواد", img: "assets/icons/menu_task.svg", widget: ProductType(), ),
    (name: "المستودعات", img: "assets/icons/menu_task.svg", widget: StoreType(), ),
    (name: "أنماط البيع", img: "assets/icons/menu_task.svg", widget: PatternType(), ),
    (name: "الشيكات", img: "assets/icons/trip.svg", widget:ChequeType(), ),
    (name: "الاستحقاق", img: "assets/icons/garage.svg", widget: DueType(), ),
    (name: "تقرير المبيعات", img: "assets/icons/garage.svg", widget: ReportGridView(), ),
    (name: "الاحصائيات", img: "assets/icons/menu_tran.svg", widget: StatisticsType(), ),
    (name: "البائعون", img: "assets/icons/menu_setting.svg", widget: SellerType(), ),
    (name: "استيراد المعلومات", img: "assets/icons/menu_setting.svg", widget: FilePickerWidget(), ),
    (name: "الجرد", img: "assets/icons/garage.svg", widget: InventoryType(), ),
    (name: "إدارة المستخدمين", img: "assets/icons/garage.svg", widget: UserManagementType(), ),
    (name: "إدارة التارجيت", img: "assets/icons/garage.svg", widget: TargetManagementType(), ),
    (name: "إدارة الوقت", img: "assets/icons/garage.svg", widget: TimeType(), ),
    (name: "إدارة البطاقات", img: "assets/icons/garage.svg", widget: CardManagementType(), ),
    (name: "إدارة قواعد البيانات", img: "assets/icons/garage.svg", widget: DataBaseType(), ),
  ];
