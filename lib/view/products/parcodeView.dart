      ...
      body: Center(
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Center(
                    child: BarcodeWidget(
                      ...
                      data:barcodeController.text, // البيانات التي تريد تشفيرها في الباركود
                      width: 400,
                      height: 160,
                    ),
                  ),
            ...
            AppButton(title: "print", onPressed: (){
        ...
        build: (pw.Context context) {
          return pw.Column(
            children: [
              ...
              pw.SizedBox(height: 20), // مسافة
              pw.Text('Product Name: ABC Product'), // اسم المنتج
              pw.Text('Price: \$10.00'), // السعر
              pw.Text('SKU: 12345'), // كود المنتج
              pw.SizedBox(height: 20), // مسافة
              pw.BarcodeWidget(
              ...
              pw.SizedBox(height: 20), // مسافة
              pw.Text('Scan the barcode above for more information'), // نص إضافي
            ],
          );
        },
      ),
