...
class ImportingDateLayout extends StatelessWidget {
  ImportingDateLayout({super.key});
  ...
  Widget build(BuildContext context) {
    final importViewModel = Get.find<ImportController>();
            ...
            children: [
              StatefulBuilder(builder: (context, setState) {
                return DropdownButton(
                    value: separator,
                    items: allSeparator.map((e) => DropdownMenuItem(value: allSeparatorValue[allSeparator.indexOf(e)], child: Text(e))).toList(),
                    onChanged: (_) {
                      setState(() {
                        separator = _;
                      });
