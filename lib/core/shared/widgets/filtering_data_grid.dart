                              ...
                              .map((e) => GridColumn(
                                  ...
                                  label: Column(
                                    children: [
                                      ...
                                      Expanded(
                                        child:  Text(
                                              e.key.toString() == (widget.globalType != null ? constructor.toMap(type: widget.globalType).entries : constructor.toMap().entries).last.key ? '${e.key}\n' : e.key.toString() + tab,
          ...
          children: [
            ...
            Expanded(
              child: Row(
                ...
                children: [
                  Text(
                    row.getCells().last.columnName == row.getCells()[index].columnName ? '${row.getCells()[index].value??""}\n' : (row.getCells()[index].value??"").toString() + tab,
