...
class GlobalModel {
  String? bondId, bondDescription, bondTotal, bondDate, bondCode, bondType, invId, invName, invSubTotal, invPrimaryAccount, invSecondaryAccount, invStorehouse, invComment, invType, invRecId, invRecProduct, invRecAmount, invRecSubTotal, invRecTotal, invoiceAccount, invRecQuantity, originId, patternId, invCode, invSeller, invDate;
  double? invTotal;
