...
class AccountCustomer {
  ...
  AccountCustomer.fromJsonPluto(
      Map<dynamic, dynamic> json, String mainAccountId) {
    customerVAT = json['customerVAT'];
    customerCardNumber = json['customerCardNumber'];
    customerAccountName = json['customerAccountName'];
    mainAccount = mainAccountId;
    customerAccountId =
        json['customerAccountId'] ?? generateId(RecordType.accCustomer);
  }
  ...
  Map<PlutoColumn, dynamic> toEditedMap() {
    return {
      ...
      PlutoColumn(
          ...
          type: PlutoColumnType.text()): customerCardNumber,
      PlutoColumn(
        title: 'اسم الزبون',
