    ...
    switch (type) {
      case AppConstants.typeAccountView:
        return {
          ...
          "نوع السند": accountRecordType?.startsWith("pat") == true
              ? getPatNameFromId(accountRecordType ?? '')
              : accountRecordType?.startsWith("cheq") == true
                  ? getChequeTypeFromEnum(accountRecordType!)
                  : getBondTypeFromEnum(accountRecordType ?? ''),
